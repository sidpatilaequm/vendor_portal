...
const AdminUsers = () => {
  ...
  // Vendor accounts are managed from Master Data → Vendors now (same edit/deactivate
  // capability lives there, on each vendor's own profile) — this screen is staff-only.

...
const DashboardHome = ({ isAdmin, onNavigate }) => {
  const { currentUser, logout, selectedCompanyCode, orgConfig } = useAuth();
      ...
      <div className="wrap">
        ...
        <div className="tile-grid">
          ...
          <div className="tile" onClick={(e) => handleNavigation(e, 'pr')}>
            ...
            <div className="chain">
              {orgConfig?.prToPoEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'pr-approval-report')}><i className="ni c-violet"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.4 3.4h8L18 6.9v13.7H6.4z" /><path d="M14.4 3.4v3.5h3.6" /><path d="M9.2 11h5.6M9.2 14.2h5.6M9.2 17.4h3.2" /></svg></i><span className="nl">Quotation Acknowledgement</span></span>)}
              {orgConfig?.prToPoEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'quotation')}><i className="ni c-amber"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.6 5.2h16.8v9.8h-8.2L7.6 18.8v-3.8H3.6z" /><path d="M12 7.4v5.4" /><path d="M13.7 8.7a1.7 1.7 0 0 0-3.1.5c0 1.6 3 .9 3 2.4a1.7 1.7 0 0 1-3.1.5" /></svg></i><span className="nl">Quotation</span></span>)}
              {orgConfig?.prToPoEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'po')}><i className="ni c-teal"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9.8" cy="19" r="1.5" /><circle cx="17.4" cy="19" r="1.5" /><path d="M2.6 4h2.7l2.5 11.4h10.6l1.9-7.8H7.3" /></svg></i><span className="nl">Purchase Orders</span></span>)}
              ...
              {orgConfig?.gateEntryShowToVendorEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'gate-entry')}><i className="ni c-blue"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 20.6V7.4h7.4v13.2" /><path d="M11.4 12.4h8.6v8.2h-8.6" /><path d="M7 10.6h1.4M7 14.2h1.4" /><path d="M14.4 16.4h3.8M16.6 14.6l1.8 1.8-1.8 1.8" /></svg></i><span className="nl">Gate Entry</span></span>)}
              ...
              {orgConfig?.invoiceVerificationEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'invoice')}><i className="ni c-teal"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.2 3.4h8L18 7v13.6H6.2z" /><path d="M14.2 3.4v3.6H18" /><path d="M12 9.8v7" /><path d="M13.7 11a1.6 1.6 0 0 0-3-.4c0 1.5 3 .8 3 2.3a1.6 1.6 0 0 1-3 .4" /></svg></i><span className="nl">Invoice</span></span>)}
              {orgConfig?.vendorPaymentsEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'vendor-payment')}><i className="ni c-green"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.4 6.8h17.2v10.4H3.4z" /><path d="M3.4 10.4h17.2" /><path d="M6.6 14.2h3.6" /></svg></i><span className="nl">Vendor Payment</span></span>)}
              {orgConfig?.vendorReturnsEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'vendor-returns')}><i className="ni c-red"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.4 5.4v5.4h5.4" /><path d="M5.2 10.6a7.4 7.4 0 1 1 1.2 5.6" /></svg></i><span className="nl">Vendor Returns</span></span>)}
              {orgConfig?.creditNotesEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'credit-note')}><i className="ni c-pink"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.2 3.4h8L18 7v4.4" /><path d="M14.2 3.4v3.6H18" /><path d="M6.2 3.4v17.2h5.6" /><path d="M20.4 13.4 14.8 19l-2.8.8.8-2.8 5.6-5.6z" /></svg></i><span className="nl">Credit Notes</span></span>)}
            </div>
          </div>
          )}
          ...
          <div className="tile" onClick={(e) => handleNavigation(e, 'pr')}>
            ...
            <div className="chain">
              ...
              {orgConfig?.prToPoEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'quotation')}><i className="ni c-amber"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.6 5.2h16.8v9.8h-8.2L7.6 18.8v-3.8H3.6z" /><path d="M12 7.4v5.4" /><path d="M13.7 8.7a1.7 1.7 0 0 0-3.1.5c0 1.6 3 .9 3 2.4a1.7 1.7 0 0 1-3.1.5" /></svg></i><span className="nl">Quotation</span></span>)}
              {orgConfig?.prToPoEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'po')}><i className="ni c-teal"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9.8" cy="19" r="1.5" /><circle cx="17.4" cy="19" r="1.5" /><path d="M2.6 4h2.7l2.5 11.4h10.6l1.9-7.8H7.3" /></svg></i><span className="nl">Purchase Orders</span></span>)}
              {orgConfig?.prToPoEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'po')}><i className="ni c-violet"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 3.4h12v17.2H6z" /><path d="M9 8.4h6M9 12h6M9 15.6h3.4" /></svg></i><span className="nl">Service Entry Sheet</span></span>)}
              {orgConfig?.prToPoEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'po')}><i className="ni c-green"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="8.2" /><path d="M8.4 12.2l2.6 2.6 4.8-4.8" /></svg></i><span className="nl">Acceptance</span></span>)}
              {orgConfig?.invoiceVerificationEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'invoice')}><i className="ni c-teal"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.2 3.4h8L18 7v13.6H6.2z" /><path d="M14.2 3.4v3.6H18" /><path d="M12 9.8v7" /><path d="M13.7 11a1.6 1.6 0 0 0-3-.4c0 1.5 3 .8 3 2.3a1.6 1.6 0 0 1-3 .4" /></svg></i><span className="nl">Invoice</span></span>)}
              {orgConfig?.vendorPaymentsEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'vendor-payment')}><i className="ni c-green"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.4 6.8h17.2v10.4H3.4z" /><path d="M3.4 10.4h17.2" /><path d="M6.6 14.2h3.6" /></svg></i><span className="nl">Vendor Payment</span></span>)}
              {orgConfig?.creditNotesEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'credit-note')}><i className="ni c-pink"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.2 3.4h8L18 7v4.4" /><path d="M14.2 3.4v3.6H18" /><path d="M6.2 3.4v17.2h5.6" /><path d="M20.4 13.4 14.8 19l-2.8.8.8-2.8 5.6-5.6z" /></svg></i><span className="nl">Credit Notes</span></span>)}
            </div>
          ...
          <div className="tile" onClick={(e) => handleNavigation(e, 'po')}>
            ...
            <div className="chain">
              {orgConfig?.prToPoEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'po')}><i className="ni c-violet"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.6 6h14.8v14.4H4.6z" /><path d="M4.6 10h14.8" /><path d="M8.6 3.6v4M15.4 3.6v4" /><path d="M8.2 13.4h2M8.2 16.8h2M13.8 13.4h2M13.8 16.8h2" /></svg></i><span className="nl">Scheduling Agreement</span></span>)}
              {orgConfig?.prToPoEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'po')}><i className="ni c-violet"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.6 6h14.8v14.4H4.6z" /><path d="M4.6 10h14.8" /><path d="M8.6 3.6v4M15.4 3.6v4" /><path d="M8.6 15.6h6" /><path d="M12.6 13.4l2.2 2.2-2.2 2.2" /></svg></i><span className="nl">Schedule Release</span></span>)}
              <span className="node" onClick={(e) => handleNavigation(e, 'asn')}><i className="ni c-orange"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2.8 7.2h9.6v8.6H2.8z" /><path d="M12.4 10.2h3.7l2.6 2.9v2.7h-6.3z" /><circle cx="6.6" cy="17.8" r="1.7" /><circle cx="16.4" cy="17.8" r="1.7" /></svg></i><span className="nl">ASN</span></span>
              {orgConfig?.gateEntryShowToVendorEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'gate-entry')}><i className="ni c-blue"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 20.6V7.4h7.4v13.2" /><path d="M11.4 12.4h8.6v8.2h-8.6" /><path d="M7 10.6h1.4M7 14.2h1.4" /><path d="M14.4 16.4h3.8M16.6 14.6l1.8 1.8-1.8 1.8" /></svg></i><span className="nl">Gate Entry</span></span>)}
              <span className="node" onClick={(e) => handleNavigation(e, 'stock')}><i className="ni c-teal"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="6.4" r="2.5" /><circle cx="6.8" cy="16.2" r="2.5" /><circle cx="17.2" cy="16.2" r="2.5" /><path d="M10.7 8.6 8.1 13.9M13.3 8.6l2.6 5.3M9.3 16.2h5.4" /></svg></i><span className="nl">Stock</span></span>
              {orgConfig?.invoiceVerificationEnabled !== false && (<span className="node" onClick={(e) => handleNavigation(e, 'invoice')}><i className="ni c-teal"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.2 3.4h8L18 7v13.6H6.2z" /><path d="M14.2 3.4v3.6H18" /><path d="M12 9.8v7" /><path d="M13.7 11a1.6 1.6 0 0 0-3-.4c0 1.5 3 .8 3 2.3a1.6 1.6 0 0 1-3 .4" /></svg></i><span className="nl">Invoice</span></span>)}
